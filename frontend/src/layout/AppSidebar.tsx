...
const navItems: NavItem[] = [
  ...
  },
  {
    icon: <ListIcon />,
    name: "Orders",
    subItems: [{ name: "Trodat Register", path: "/trodat-orders" }],
  },
  {
    name: "Manage",
    icon: <TaskIcon />,
    subItems: [{ name: "Cash register", path: "/cash-register" },
    { name: "Tampons Stock", path: '/tampon-stock' },
    { name: "Notebooks ( credit )", path: "/notebooks" }
    ],
  },
  {
    icon: <CalenderIcon />,
...
const othersItems: NavItem[] = [
  ...
  },
  {
    ...
    name: "Authentication",
    subItems: [
      { name: "Register Client", path: "/register" },
    ],
  },
];
